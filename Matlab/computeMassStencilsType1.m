            ...
            for i=1:8
                ...
                for j=1:8
                    ...
                    for m=1:2
                        for n=1:2
                            for p=1:2
                                cShVal_i = evalPhi(cSh_i,((Xfac1*gpt(m))+Xfac2),((Yfac1*gpt(n))+Yfac2),((Zfac1*gpt(p))+Zfac2));
                                cShVal_j = evalPhi(cSh_j,((Xfac1*gpt(m))+Xfac2),((Yfac1*gpt(n))+Yfac2),((Zfac1*gpt(p))+Zfac2));
